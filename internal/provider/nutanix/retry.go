...
// isNutanixAuthError returns true if the error looks like a Nutanix
// authentication or authorisation failure.
func isNutanixAuthError(err error) bool {
	if err == nil {
		return false
	}
...
// isRetryableOperationError returns true for transient Nutanix operation
